...
+ function($) {
  ...
  var Picker = function (params) {
      ...
      var defaults = {
          ...
          </div><div class="data-col"><span>年</span><span>月</span><span>日</span></div>',
      };
      params = params || {};
      ...
      p.layout = function () {
          ...
          pickerHTML =
              '<div class="' + (pickerClass) + '">' +
                  ...
                  '</div>' +
              '<div class="enter_date close-picker">确定</div></div>';
  ...
  $.openPicker = function(tpl, className, callback) {
    ...
    var container = $("<div class='mask'><div class='weui-picker-container "+ (className || "") + "'></div></div>").appendTo(document.body);
    container.show();
 ...
 $(document).on("click touchstart touchend",".enter_date",function(){
	 var data_value="";
	$(".picker-selected").each(function(index) {
		data_value=data_value+$(this).html()+"-";
		$(".dispaly_value").val(data_value.substring(0,10));
